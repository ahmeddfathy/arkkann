...
class MarketingReviewController extends Controller
{
    ...
    private function validateReview(Request $request)
    {
        return $request->validate([
            ...
            'deliver_complete_project_score' => ['required', 'integer', 'min:0', 'max:20'],
            'project_formatting_score' => ['required', 'integer', 'min:0', 'max:20'],
            'no_project_revisions_score' => ['required', 'integer', 'min:0', 'max:20'],
            'continuous_update_score' => ['required', 'integer', 'min:0', 'max:20'],
            'competitor_analysis_score' => ['required', 'integer', 'min:0', 'max:20'],
            'data_presentation_change_score' => ['required', 'integer', 'min:0', 'max:0'],
            'project_sheet_update_score' => ['required', 'integer', 'min:0', 'max:10'],
            'timing_sheet_completion_score' => ['required', 'integer', 'min:0', 'max:10'],
            'new_business_ideas_score' => ['required', 'integer', 'min:0', 'max:10'],
            'new_sources_score' => ['required', 'integer', 'min:0', 'max:15'],
            'new_demand_measurement_score' => ['required', 'integer', 'min:0', 'max:10'],
            'team_leader_tasks_score' => ['required', 'integer', 'min:0', 'max:0'],
            'economic_impact_score' => ['required', 'integer', 'min:0', 'max:15'],
            'economic_report_score' => ['required', 'integer', 'min:0', 'max:15'],
            'new_data_sources_score' => ['required', 'integer', 'min:0', 'max:20'],
            'client_calls_score' => ['required', 'integer', 'min:0', 'max:10'],
            'potential_client_calls_score' => ['required', 'integer', 'min:0', 'max:0'],
            'project_questions_score' => ['required', 'integer', 'min:0', 'max:15'],
            'project_followup_score' => ['required', 'integer', 'min:0', 'max:15'],
            'team_leader_evaluation_score' => ['required', 'integer', 'min:0', 'max:10'],
            'hr_evaluation_score' => ['required', 'integer', 'min:0', 'max:10'],
            'core_revisions_penalty' => ['required', 'integer', 'min:0', 'max:25'],
            'spelling_errors_penalty' => ['required', 'integer', 'min:0', 'max:10'],
            'content_errors_penalty' => ['required', 'integer', 'min:0', 'max:20'],
            'minimum_projects_penalty' => ['required', 'integer', 'min:0', 'max:10'],
            'old_draft_words_penalty' => ['required', 'integer', 'min:0', 'max:15'],
            'sheets_commitment_penalty' => ['required', 'integer', 'min:0', 'max:20'],
            'work_behavior_penalty' => ['required', 'integer', 'min:0', 'max:15'],
