...
<div class="row mb-4">
    ...
    ->having('users_count', '>', 1)
    ->exists() ||
    (Auth::user()->hasRole(['department_manager', 'technical_department_manager', 'marketing_department_manager', 'customer_service_department_manager', 'coordination_department_manager', 'project_manager']) && isset($statistics['team'])) ||
