    ...
    <div class="customer-service-reviews-container">
        ...
        <div class="customer-service-reviews-card">
            <div class="customer-service-reviews-card-header">
                <span>نموذج تعديل التقييم</span>
            </div>

            <div class="customer-service-reviews-card-body">
                <form action="{{ route('customer-service-reviews.update', $review) }}" method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="customer-service-reviews-form-group">
                                    ...
                                    <input type="month" name="review_month" value="{{ old('review_month', $review->review_month) }}" class="customer-service-reviews-form-control" required>
                                    @error('review_month')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="customer-service-reviews-form-group">
                                    ...
                                    <input type="number" name="{{ $field }}" value="{{ old($field, $review->$field) }}" min="0" max="{{ $data[1] }}" class="customer-service-reviews-form-control" required placeholder="الحد الأقصى {{ $data[1] }}">
                                    @error($field)
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="customer-service-reviews-form-group">
                                    ...
                                    <input type="number" name="additional_bonus" value="{{ old('additional_bonus', $review->additional_bonus) }}" min="0" class="customer-service-reviews-form-control" required>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="customer-service-reviews-form-group">
                                    ...
                                    <input type="number" name="additional_deduction" value="{{ old('additional_deduction', $review->additional_deduction) }}" min="0" class="customer-service-reviews-form-control" required>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="customer-service-reviews-form-group">
                                    ...
                                    <input type="number" step="0.01" name="total_salary" value="{{ old('total_salary', $review->total_salary) }}" min="0" class="customer-service-reviews-form-control" required>
                                    @error('total_salary')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="customer-service-reviews-form-group">
                                    ...
                                    <textarea name="notes" rows="3" class="customer-service-reviews-form-control">{{ old('notes', $review->notes) }}</textarea>
                                    @error('notes')
                                    <div class="text-danger mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
